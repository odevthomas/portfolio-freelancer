  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full px-6 sm:px-12 py-10 flex flex-col sm:flex-row items-center justify-between">
        {/* Texto e descrição */}
        <div className="text-white sm:w-1/2 w-full text-left sm:pr-8 mb-8 sm:mb-0 flex flex-col justify-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-4 text-gray-300 leading-relaxed drop-shadow-md max-w-full text-justify">
            Minha abordagem inovadora no design de interfaces digitais combina criatividade com praticidade, criando soluções que não apenas encantam, mas também oferecem uma experiência fluida e intuitiva.
          </p>
          <p className="text-lg sm:text-xl md:text-2xl mb-8 text-gray-300 leading-relaxed drop-shadow-md max-w-full text-justify">
            Cada projeto é uma oportunidade de reinventar a forma como as pessoas interagem com a tecnologia, convertendo ideias abstratas em experiências reais que marcam e conquistam os usuários.
          </p>
          <a
        ...
        {/* Imagem ao lado do texto, movida mais para cima */}
        <div className="relative sm:w-1/2 w-full mt-8 sm:mt-0 flex justify-center">
          <img
            src="/imagens fundos/img7.jpg"
            alt="Profissional Confiante"
            className="rounded-lg shadow-xl w-full h-auto object-cover transform -translate-y-12"  // A imagem foi movida para cima
          />
        </div>
      </div>
