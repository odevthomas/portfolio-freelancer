...
const UniqueApproachSection = () => {
  const [buttonText, setButtonText] = useState('Vamos Conversar no WhatsApp'); // Estado para o texto do botão
  ...
  const handleMouseLeave = () => {
    setButtonText('Vamos Conversar no WhatsApp');
  };
